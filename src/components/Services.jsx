...
function brushIcon(){
    return (
        <>
           <svg xmlns="http://www.w3.org/2000/svg" fill="none" color={"#14b8a6"} viewBox="0 0 24 24" strokeWidth="1.2" stroke="currentColor" className="w-14 h-14">
            <motion.path
...
function SourceCodeSquareIcon(){
  return (
      <>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={42} height={42} color={"#4a90e2"} fill={"none"}>
...
export function Services() {
  return (
    ...
    >
    <div className="bg-white/90 dark:bg-[#171313] ">
      ...
      <Container>
             ...
             <SimpleLayout
                ...
                intro='From Stunning Designs to Seamless Functionality, I Got You Covered.'
                className="sm:px-0 ">
             </SimpleLayout> 

        <FadeInStagger
          role="list"
          className="mx-auto my-10 grid max-w-2xl grid-cols-1 gap-6 text-sm sm:mt-10 sm:grid-cols-2 md:gap-y-10 lg:max-w-none lg:grid-cols-3"
        >
                   
          {features.map((feature) => (
            <FadeIn
              key={feature.name}
              className={clsx("rounded-xl border border-gray-200 p-8 px-6 py-4 bg-white/80 sm:py-8 sm:px-12  lg:p-8  dark:border-gray-200/5 dark:bg-white/5 ")}
            >
             ...
             <feature.icon className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-10 w-10" />
              ...
              <p className="mt-2 text-base text-gray-700 dark:text-zinc-300">{feature.description}</p>

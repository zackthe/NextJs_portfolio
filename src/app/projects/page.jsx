...
import portfolio1 from '@/images/projects/portfolio_V1.png'
import digency from '@/images/projects/digency-moc.png'
...
const projects = [
...

  {
   ...
   link: { href: 'https://zakariaebelkasmi.netlify.app/', label: 'Read case study' },
    image: cloutikMap,
...
,

  {
    ...
    link: { href: 'https://zackthe.github.io/Digency/', label: 'Visit project' },
    image: digency,
    type : 'Personal project',
    badge :  badge(['personal project']),
    tags : ['Html', 'css', 'bootsrap', 'jekyll', 'github'],

    },
    {

      id: '4' ,
      text: 'Portfolio made with jekyll',
      description:
        'My old portfolio website, I made with I started when I was learning html/css and javascript, and added jekyll as my static site generator.',
      link: { href: 'https://belkasmizakariae.netlify.app/', label: 'Visit project' },
      image: portfolio1,
      type : 'Personal project',
      badge :  badge(['personal project']),
        ...
        <FadeInStagger className="mt-10 mb-10 grid grid-cols-1 gap-8 lg:grid-cols-2">
          {projects.map((project) => (
            <FadeIn key={project.link} className="flex ">
             ...
             <article className="relative flex w-full flex-col rounded-md p-8  ring-1 bg-white/40 ring-neutral-950/5 filter backdrop-blur-md transition hover:bg-neutral-50 sm:p-8 dark: dark:bg-zinc-800/50 dark:hover:bg-zinc-800 dark:ring-zinc-700/40 ">
                <h3>

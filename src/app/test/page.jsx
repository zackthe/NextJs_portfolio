...
import image11 from '@/images/projects/image1.jpeg'
import image12 from '@/images/projects/image2.jpeg'
import spamImage from '@/images/projects/spamchecker_mockup.jpeg'
//import cloutikMap from '@/images/projects/cloutik_mac.jpeg'
//import spamSimple from '@/images/projects/spam_simple.jpeg'
...
function Shape({text , description , image, link , badge}) {
    ...
    return (
          ...
          <Container className="mt-20 lg:mb-0">
              ...
              <motion.div 
                    ...
                    whileInView="closed"
                    viewport={{once : true}}
                    className="flex flex-col items-center lg:flex-row lg:gap-[40px] px-6 py-6  rounded-xl  border-gray-200  bg-white/90  dark:border-gray-800 dark:bg-zinc-900 ">
   ...
   /* function Text (){
        ...
        const Y = useTransform(scrollYProgress, [0, 1], [0.2 , 2]);

            return( 

            <section className="flex justify-center items-center h-[100vh] bg-slate-300" >

                <CodeIcon />

                <div ref={ref} className="p-20" >

                        <motion.h1 style={{ scale : Y }} >hello there</motion.h1>
                </div>
       ...
       <SimpleLayout
        ...
        className="mt-20 px-0 lg:px-0">
           ...
           {projects.map((project) => 
            ...
            <div key={project.id}>
                <Shape  text={project.text} image={project.image} description={project.description} link={project.link} badge={project.badge}/>  
            </div>
